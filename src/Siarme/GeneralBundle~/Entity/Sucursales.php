...
class Sucursales
{
     ...
     * Add actividad.
     *
     * @param \Siarme\GeneralBundle\Entity\Actividades $actividad
     *
     * @return Sucursales
     */
    public function addActividad(\Siarme\GeneralBundle\Entity\Actividades $actividad)
    {
     ...
     */
    public function removeActividad(\Siarme\GeneralBundle\Entity\Actividades $actividad)
    {
