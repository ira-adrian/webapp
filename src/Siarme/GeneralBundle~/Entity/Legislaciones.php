...
class Legislaciones
{
     ...
     * Set tipo.
     *
     * @param \Siarme\GeneralBundle\Entity\Tiposlegislaciones|null $tipo
     *
     * @return Legislaciones
     */
    public function setTipo(\Siarme\GeneralBundle\Entity\Tiposlegislaciones $tipo = null)
    {
        $this->tipo = $tipo;
     ...
     * Get tipo.
     *
     * @return \Siarme\GeneralBundle\Entity\Tiposlegislaciones|null
     */
