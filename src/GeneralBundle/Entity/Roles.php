...
class Roles
{
     ...
     * Add permission.
     *
     * @param \GeneralBundle\Entity\Permissions $permission
     *
     * @return Roles
     */
    public function addPermission(\GeneralBundle\Entity\Permissions $permission)
    {
     ...
     */
    public function removePermission(\GeneralBundle\Entity\Permissions $permission)
    {
