...
use AusentismoBundle\Util\Util;
use AusentismoBundle\Entity\Organismo;
use DocumentoBundle\Entity\Documento;
use ExpedienteBundle\Entity\Expediente;
use ExpedienteBundle\Entity\Tramite;
use GeneralBundle\Entity\ItemAcuerdoMarco;
...
//            'expedientesPendientes' => $expedientesPendientes,
    ...
    public function newAction(Request $request, Expediente $expediente, $slug)
    {
        ...
        $form = $this->createForm('DocumentoBundle\Form\DocarchivoType', $documento);
